export const activity = [
  ...
  },
  {
    label: 'This week',
    items: [
      { id: 4, type: 'follow', actor: 'dev_clara', text: 'also follows the AI topic', time: 'Yesterday', link: '/topic/ai-regulation' },
      { id: 5, type: 'mention', actor: 'marie_k', text: 'mentioned you in a reply', time: '2 d', link: '/topic/war-in-ukraine' },
    ],
  },
];